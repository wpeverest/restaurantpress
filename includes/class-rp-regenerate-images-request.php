...
class RP_Regenerate_Images_Request extends RP_Background_Process {
	...
	public function adjust_intermediate_image_sizes( $sizes ) {
		return apply_filters( 'restaurantpress_regenerate_images_intermediate_image_sizes', array( 'restaurantpress_thumbnail', 'restaurantpress_thumbnail_2x', 'restaurantpress_single' ) );
	}
}

...
if ( ! class_exists( 'RP_Admin_Settings', false ) ) :
	...
	class RP_Admin_Settings {
		...
		public static function save() {
			...
			check_admin_referer( 'restaurantpress-settings' );
				...
				switch ( $value['type'] ) {
					...
					case 'single_select_page':
						...
						<tr valign="top" class="single_select_page">
							...
							<td class="forminp">
								<?php echo str_replace( ' id=', " data-placeholder='" . esc_attr__( 'Select a page&hellip;', 'restaurantpress' ) . "' style='" . $value['css'] . "' class='" . $value['class'] . "' id=", wp_dropdown_pages( $args ) ); // WPCS: XSS ok. ?> <?php echo $description; // WPCS: XSS ok. ?>
							</td>
						</tr>
						<?php
						break;

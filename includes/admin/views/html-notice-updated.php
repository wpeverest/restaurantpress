...
<div id="message" class="updated restaurantpress-message rp-connect restaurantpress-message--success">
	...
	<p><?php printf( __( 'RestaurantPress data update has been successfully complete. <strong>Please, update your restaurant %scurrency symbol%s now </strong>. Thank you for updating to the latest version!', 'restaurantpress' ), '<a href="' . admin_url( 'admin.php?page=rp-settings' ) . '">', '</a>' ); ?></p>
</div>

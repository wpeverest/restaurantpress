...
<div id="message" class="updated restaurantpress-message rp-connect restaurantpress-message--success">
	...
	<p><?php printf( __( 'RestaurantPress data update complete. <strong>Please update your restaurant</strong> %scurrency symbol%s. Thank you for updating to the latest version!', 'restaurantpress' ), '<a href="' . admin_url( 'admin.php?page=rp-settings' ) . '">', '</a>' ); ?></p>
</div>

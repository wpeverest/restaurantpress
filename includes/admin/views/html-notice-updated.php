...
<div id="message" class="updated restaurantpress-message rp-connect restaurantpress-message--success">
	...
	<p><?php printf( __( 'RestaurantPress data update complete. <strong>Please, update your restaurant %1$scurrency symbol%2$s now.</strong> Thank you for updating to the latest version!', 'restaurantpress' ), '<a href="' . admin_url( 'admin.php?page=rp-settings' ) . '">', '</a>' ); ?></p>
</div>

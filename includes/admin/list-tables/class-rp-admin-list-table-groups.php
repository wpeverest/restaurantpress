...
class RP_Admin_List_Table_Groups extends RP_Admin_List_Table {
	...
	protected function render_blank_state() {
		...
		echo '<a class="restaurantpress-BlankState-cta button-primary button" href="' . esc_url( admin_url( 'edit.php?post_type=food_group' ) ) . '">' . esc_html__( 'Create your first food group!', 'restaurantpress' ) . '</a>';
		echo '</div>';
	}
}

...
class RP_Admin_Addons {
	...
	public static function get_sections() {
		if ( false === ( $sections = get_transient( 'rp_addons_sections' ) ) ) {
			$raw_sections = wp_safe_remote_get( 'https://raw.githubusercontent.com/wpeverest/extensions-json/master/restaurantpress/addon-section.json', array( 'user-agent' => 'UserRegistration Addons Page' ) );

 ...
 *
 * This template can be overridden by copying it to yourtheme/restaurantpress/notices/success.php.
 *
...
<?php foreach ( $messages as $message ) : ?>
	<div class="restaurantpress-message" role="alert"><?php echo wp_kses_post( $message ); ?></div>
<?php endforeach; ?>

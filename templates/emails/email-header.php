 ...
 * Email Header
 *
 * This template can be overridden by copying it to yourtheme/restaurantpress/emails/email-header.php.
 *
				...
				<tr>
					<td align="center" valign="top">
						<div id="template_header_image">
							<?php
								if ( $img = get_option( 'restaurantpress_email_header_image' ) ) {

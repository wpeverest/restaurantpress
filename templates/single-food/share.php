 ...
 *
 * This template can be overridden by copying it to yourtheme/restaurantpress/single-food/share.php.
 *
...
<?php do_action( 'restaurantpress_share' ); // Sharing plugins can hook into here

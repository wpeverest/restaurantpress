<?php
/**
 * Test RP_Background_Process functionality
 *
 * A mock class for testing the RP_Background_Process functionality.
 *
 * @since 1.7
 */
class RP_Mock_Background_Process extends RP_Background_Process {
	...
	public function __construct() {
		...
		$this->action = 'rp_mock_background_process';
		parent::__construct();
	}
